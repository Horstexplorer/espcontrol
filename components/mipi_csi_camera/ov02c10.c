...
// Vendored into mipi_csi_camera from JC8012P4A1C_I_W_Y_New_Panel's
// video_lcd_display/components/esp_cam_sensor/sensors/ov02c10 reference SDK
// (see components/mipi_csi_camera/README.md for details). Only wired up for
// ESP32-P4; see mipi_csi_camera.h/.cpp for how this file gets selected.
#ifdef USE_ESP32_VARIANT_ESP32P4

#include "ov02c10_compat.h"
